...
namespace SNIBypassGUI.Consts
{
    public static class AppConsts
    {
        ...
        [
            ...
            "Arbitrary truncation of logs is unacceptable. Unless you possess full clarity",
            "on the significance of the data, you must preserve the content in its entirety.",
            "——————————————————————————————————————————"
        ];
        ...
        public readonly static string[] ImageExtensions = [".jpg", ".jpeg", ".png", ".bmp"];
