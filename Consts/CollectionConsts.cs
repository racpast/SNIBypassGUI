...
{
    /// <summary>
    /// Defines static collection constants used throughout the application.
    /// </summary>
    public static class CollectionConsts
    {
        /// <summary>
        /// A read-only dictionary mapping file paths to their corresponding embedded resource byte arrays.
        /// Used for file extraction and initialization.
        /// </summary>
        public static readonly ReadOnlyDictionary<string, byte[]> FileResourceMap = new(new Dictionary<string, byte[]>
        {
            { Nginx, Properties.Resources.SNIBypass },
            { NginxConfig, Properties.Resources.nginx },
            { CA, Properties.Resources.ca },
        ...
        /// <summary>
        /// A read-only dictionary mapping default background filenames to their embedded image resources.
        /// </summary>
        public static readonly ReadOnlyDictionary<string, byte[]> DefaultBackgroundMap = new(new Dictionary<string, byte[]>
        {
        ...
        /// <summary>
        /// A read-only dictionary mapping application versions to arrays of valid background image hashes.
        /// Used for verifying legacy resources.
        /// </summary>
        public static readonly ReadOnlyDictionary<string, string[]> BackgroundHashesByVersion = new(new Dictionary<string, string[]>
        {
        ...
        public static readonly ObservableCollection<SwitchItem> Switches = [];
    }
}
