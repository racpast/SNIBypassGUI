...
{
    public static class SystemHostsConsts
    {
        ...
        public static string[] APKMirrorSection =
        [
            "#\tAPKMirror Start",
            "127.0.0.1       apkmirror.com",
            "127.0.0.1       www.apkmirror.com",
            "#\tAPKirror End",
        ];
        ...
        [
            ...
            "127.0.0.1       unagi.amazon.co.jp",
            "127.0.0.1       completion.amazon.co.jp",
        ...
        [
            ...
            "127.0.0.1       shop.bbc.com",
            "127.0.0.1       session.bbc.com",
            "127.0.0.1       account.bbc.com",
            "127.0.0.1       bbc.co.uk",
            "127.0.0.1       a1.api.bbc.co.uk",
            "127.0.0.1       idcta.api.bbc.com",
            "127.0.0.1       open.live.bbc.co.uk",
            "127.0.0.1       static.files.bbci.co.uk",
            "127.0.0.1       static.bbci.co.uk",
            "127.0.0.1       emp.bbci.co.uk",
            "127.0.0.1       r.bbci.co.uk",
            "127.0.0.1       web-cdn.api.bbci.co.uk",
            "127.0.0.1       ichef.bbci.co.uk",
            "127.0.0.1       gn-web-assets.api.bbc.com",
            "127.0.0.1       mybbc-analytics.files.bbci.co.uk",
            "#\tBBC End"
        ];

        public static string[] EtsySection =
        [
            "#\tEtsy Start",
            "127.0.0.1       etsy.com",
            "127.0.0.1       www.etsy.com",
            "127.0.0.1       careers.etsy.com",
            "127.0.0.1       investors.etsy.com",
            "127.0.0.1       s.pinimg.com",
            "127.0.0.1       ct.pinterest.com",
            "#\tEtsy End"
        ];

        public static string[] FDroidSection =
        [
            "#\tF-Droid Start",
            "127.0.0.1       forum.f-droid.org",
            "127.0.0.1       f-droid.org",
            "127.0.0.1       www.f-droid.org",
            "#\tF-Droid End"
        ];
        ...
        public static string[] OKXCOMSection =
        [
            "#\tOKX.COM Start",
            "127.0.0.1       okx.com",
            "127.0.0.1       www.okx.com",
            "#\tOKX.COM End"
        ];

        public static string[] OKSection =
        [
            "#\tOK Start",
            "127.0.0.1       ok.ru",
            "127.0.0.1       www.ok.ru",
            "127.0.0.1       live.ok.ru",
            "#\tOK End"
        ];

        public static string[] TelegramSection =
        [
            "#\tTelegram Start",
            "127.0.0.1       telegram.org",
            "127.0.0.1       www.telegram.org",
            "127.0.0.1       core.telegram.org",
            "127.0.0.1       web.telegram.org",
            "127.0.0.1       translations.telegram.org",
            "127.0.0.1       instantview.telegram.org",
        ...
        public static string[] TheNewYorkTimesSection =
        [
            "#\tThe New York Times Start",
            "127.0.0.1       nytimes.com",
            "127.0.0.1       www.nytimes.com",
            "127.0.0.1       a.nytimes.com",
            "127.0.0.1       cn.nytimes.com",
            "127.0.0.1       help.nytimes.com",
            "127.0.0.1       dd.nytimes.com",
            "127.0.0.1       als-svc.nytimes.com",
            "127.0.0.1       purr.nytimes.com",
            "127.0.0.1       samizdat-graphql.nytimes.com",
            "127.0.0.1       a.et.nytimes.com",
            "127.0.0.1       myaccount.nytimes.com",
            "127.0.0.1       nyt.com",
            "127.0.0.1       a1.nyt.com",
            "127.0.0.1       g1.nyt.com",
            "127.0.0.1       vp.nyt.com",
            "127.0.0.1       static01.nyt.com",
            "#\tThe New York Times End"
        ];

        public static string[] ProtonSection =
        [
            "#\tProton Start",
            "127.0.0.1       proton.me",
            "127.0.0.1       www.proton.me",
            "127.0.0.1       account.proton.me",
            "127.0.0.1       account-api.proton.me",
            "127.0.0.1       mail.proton.me",
            "127.0.0.1       calendar.proton.me",
            "127.0.0.1       drive.proton.me",
            "127.0.0.1       pass.proton.me",
            "#\tProton End"
        ];
        ...
        [
            ...
            "143.244.49.177       v.sankakucomplex.com",
            "192.169.120.162       f.sankakucomplex.com",
        ...
        public static string[] GreasyForkSection =
        [
             "#\tGreasy Fork Start",
