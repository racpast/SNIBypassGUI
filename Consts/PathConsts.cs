...
namespace SNIBypassGUI.Consts
{
    public static class PathConsts
    {
        ...
        public static readonly string nginxLogFile_A = Path.Combine(nginxLogDirectory, "access.log");
        public static readonly string nginxLogFile_B = Path.Combine(nginxLogDirectory, "error.log");
        ...
        public static readonly string AcrylicDebugLogFilePath = Path.Combine(dnsDirectory, "AcrylicDebug.txt");
        ...
        public static readonly List<string> TempFilesPaths = [nginxLogFile_A, nginxLogFile_B, AcrylicCacheFilePath];
        public static readonly List<string> TempFilesPathsIncludingGUILogs = [nginxLogFile_A, nginxLogFile_B, AcrylicCacheFilePath, LogDirectory];
